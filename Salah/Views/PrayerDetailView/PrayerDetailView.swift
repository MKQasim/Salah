...
struct PrayerDetailView: View {
    ...
    func updateCounter() {
        ...
        startDate?.startCountdownTimer(from: unwrappedStartDate, to: endDate, getNextPrayerAndSetTimer: getNextPrayerTime(unwrappedStartDate)) { formattedTime in
